...
lowPtTripletStepTracks = RecoTracker.TrackProducer.TrackProducerIterativeDefault_cfi.TrackProducerIterativeDefault.clone(
...
(pp_on_AA & trackdnn).toModify(lowPtTripletStep, qualityCuts =  [-0.29, 0.65, 0.98] )
